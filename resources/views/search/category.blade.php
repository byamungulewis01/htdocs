                ...
                <div class="card-body p-0">
                  ...
                  <div class="d-flex align-items-center pt-1">
                    <div class="ms-auto">
                      ...
                      {{-- <a href="javascript:;" class="me-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-dark" data-bs-original-title="{{ $user->laws->description }}"><span class="badge bg-label-dark">{{ $user->laws->title }}</span></a>
                   --}}
                    </div>
                  </div>
                </div>
