                ...
                <div class="card-header">
                    <h4 class="card-header-title">Export Cases 
                        <span class="float-end">
                            <form action="{{ route('probono.report') }}">
                            <div class="input-group input-daterange" id="bs-datepicker-daterange">
                                <input required name="from" id="startdate" type="text" value="{{ $from }}" class="form-control">
                                <span class="input-group-text">to</span>
                                <input required name="to" id="enddate" type="text" value="{{ $to }}"  class="form-control">
...
<script>
    ...
    dte&&dte.flatpickr({altInput:!0,altFormat:"F j, Y",dateFormat:"Y-m-d"});
        ...
        $('#datatables').DataTable({
            ...
            ajax: '/api/probono?from={{ $from }}&to={{ $to }}',
            columns: [
                { data: '' },
                { data: 'gender' },
                { data: 'age' },
