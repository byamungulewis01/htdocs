...
<div class="container-xxl flex-grow-1 container-p-y">
            <div class="card">
              <div class="card-header border-bottom">
                <h5 class="card-title mb-0">Active users<a class="d-none" id="edit" data-bs-toggle="modal" data-bs-target="#editUser"></a></h5>
...
$(function(){
    ...
    n.length&&(e=n.DataTable({
        ajax:"{{ env('APP_URL') }}/api/users/active",
        columns:[
            {data:"name"},
            {data:"regNumber"},
            {data:"phone"},
        ...
        $(".datatables-users tbody").on("click",".suspend-record",function(event){
            ...
            Swal.fire({
              ...
              preConfirm: () => {
                return fetch("{{ env('APP_URL') }}/api/users/active/"+id,  {
                    method: 'PUT'
                  })
                  .then(response => {
                    if (!response.ok) {
