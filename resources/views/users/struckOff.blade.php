...
<div class="container-xxl flex-grow-1 container-p-y">
            <div class="card">
              <div class="card-header border-bottom">
                <h5 class="card-title mb-0">Struck Off  Users<a class="d-none" id="edit" data-bs-toggle="modal" data-bs-target="#editUser"></a></h5>
...
$(function(){
    ...
    n.length&&(e=n.DataTable({
        ajax:"http://localhost/bar/api/users/struckOffApi",
        columns:[
            {data:"name"},
            {data:"regNumber"},
            {data:"phone"},
        ...
        $(".datatables-users tbody").on("click",".suspend-record",function(event){
            ...
            Swal.fire({
              ...
              preConfirm: () => {
                return fetch('http://localhost/bar/api/users/struckOffApi/'+id,  {
                    method: 'PUT'
                  })
                  .then(response => {
                    if (!response.ok) {
