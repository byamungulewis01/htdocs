        ...
        <div class="col-xl-7 col-md-8 col-12 mb-md-0 mb-4">
            <div class="card invoice-preview-card">
                <div class="card-header">
                    <h5><?php echo e($name); ?>'s Extra Cles </h5>
                </div>
                <div class="card-body">
...
$('.datatables').DataTable({
    ...
    ajax: "<?php echo e(env('APP_URL')); ?>/api/trainings_extra/<?php echo e($user_id); ?>",
    columns: [
        { data: '' },
        { data: 'title' },
        { data: 'category' },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/profile/training/extraCle.blade.php ENDPATH**/ ?>