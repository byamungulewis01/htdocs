            ...
            <div class="card">
              <div class="card-header border-bottom">
                <h5 class="card-title mb-0">
                  ADVOCATES
                <a class="d-none" id="edit" data-bs-toggle="modal" data-bs-target="#editUser"></a></h5>
...
$(function(){
    ...
    n.length&&(e=n.DataTable({
        ajax:"<?php echo e(env('APP_URL')); ?>/api/users/advocates",
        columns:[
            {data:"name"},
            {data:"regNumber"},
            {data:"phone"},
        ...
        $(".datatables-users tbody").on("click",".suspend-record",function(event){
            ...
            Swal.fire({
              ...
              preConfirm: () => {
                return fetch("<?php echo e(env('APP_URL')); ?>/api/users/inactiveApi/"+id,  {
                    method: 'PUT'
                  })
                  .then(response => {
                    if (!response.ok) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/users/advocate.blade.php ENDPATH**/ ?>