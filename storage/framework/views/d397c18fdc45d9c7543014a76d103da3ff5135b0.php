...
$(function(){
    ...
    n.length&&(e=n.DataTable({
        ajax:"<?php echo e(env('APP_URL')); ?>/api/users/deactiveApi",
        columns:[
            {data:""},
            {data:"name"},
            {data:"regNumber"},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/users/deactive.blade.php ENDPATH**/ ?>